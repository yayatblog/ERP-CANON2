...
<div class="modal fade" id="modalTambah" tabindex="-1" aria-labelledby="modalTambah" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="<?= base_url('juice_distri2/tambah'); ?>" class="form-horizontal" method="POST">
...
<div class="modal fade" id="modalEdit" tabindex="-1" aria-labelledby="modalEdit" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="<?= base_url('juice_distri2/edit'); ?>" class="form-horizontal" method="POST">
        <div class="modal-body">
          <div class="form-group">
            <label for="">Nama Distributor</label>
...
<script>
    ...
    function allData() {
        ...
        let fetchUrl = weekending == "" ? "juice_distri2/tampil_data" : "juice_distri2/tampil_data/" + weekending;
            ...
            success: function(result) {
                ...
                if (!results[0]) {
                    ...
                    for (let i = 0; i < results.length; i++) {
                        ...
                        <a href="<?= base_url();?>juice_distri2/hapus/${results[i].id}" class="btn btn-danger mt-2" style="" onclick="return confirm('Yakin ingin dihapus?');"><i class="fa fa-trash"></i>&nbsp;Hapus</a>
                        </td>
                        </tr>`;
                    }
                }
    ...
    function getData(id) {
        let url = "juice_distri2/getData/" + id;
