		...
		<div class="col-md-6 col-md-offset-3" >
			<br><br><br>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body" style="height: 300px; overflow-y: scroll;background-color:#ec9c12;border-radius:5px;color:white">
					<?php foreach ($chat as $c){ ?>
						<?php if($c->pengirim == $this->session->userdata('tbl_user')){ ?>
							<div class="col-md-12">
				...
				<?php if ($s->status == TRUE): ?>
					<div class="row">
						<div class="col-md-12 ">
							<form method="post" action="<?= base_url('message/kirim');?>">
								<div class="col-md-12">
