...
<?php endif;?>
<a href="<?= base_url('penjualan2/tambah');?>" class="btn btn-info mb-2">Tambah Data</a>
        ...
        <tbody>
            ...
            <tr>
                ...
                <div class="btn-group" >
                    ...
                    <a href="<?php echo base_url();?>pengeluaran2/edit/<?= $pen['id'];?>" class="btn btn-success" style="margin-left:42px"><i class="fa fa-edit"></i>Edit</i></a>
                    <a href="<?= base_url();?>pengeluaran2/hapus/<?= $pen['id'];?>" class="btn btn-danger mt-2" style="margin-left:35px" onclick="return confirm('Yakin ingin dihapus?');"><i class="fa fa-trash"></i>Hapus</a>
                    </div>
                </div>
                </td>
            </tr>
