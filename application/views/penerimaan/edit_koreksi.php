...
<form action="<?php echo base_url().'penerimaan/edit_koreksi'?>" method="post">
...
<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
 ...
 <button type="submit" class="btn btn-primary mb-2 mt-2">Koreksi</button>
 <a href="<?= base_url('penerimaan/index_tampil_print');?>" class="btn btn-success">Kembali</a>
 </form>
