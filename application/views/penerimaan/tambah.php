...
<form action="<?php echo base_url().'penerimaan/tambah'?>" method="post">
...
<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        <thead>
            ...
            <tr>
                ...
                <td style="text-align:center;">
                    <input type="text" name="kode_id" id="kode"  class="form-control form-control-sm" data-toggle="modal" data-target="#myModal1">
                </td>
                <td>
                   <input type="text" name="nama"  id="namabrg"  class="form-control form-control-sm">
                </td>
				<td style="text-align:center;">
                    <input type="text" id="gudang" name="gudang"  class="form-control form-control-sm">
                </td>
                <td style="text-align:center;">
                ...
                <td style="text-align:center;">
                   <input type="text" name="total_qty" id="txt3" onkeyup="sum();"  class="form-control form-control-sm">
                </td>
                <td style="text-align:center;">
 ...
 <button type="submit" class="btn btn-primary mb-2 mt-2">Proses</button>
 </form>
