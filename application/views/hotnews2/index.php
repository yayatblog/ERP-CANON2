...
<a href="<?= base_url('hot_news2/import');?>" class="btn btn-success mb-2">Import</a>
...
<div class="modal fade" id="modalTambah" tabindex="-1" aria-labelledby="modalTambahLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="<?= base_url('hot_news2/tambah'); ?>" method="post" enctype="multipart/form-data" >
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            type="text" name="gudang" placeholder="Masukkan gudang" value="<?= $this->session->userdata('gudang'); ?>" readonly />
            <div class="invalid-feedback">
...
<div class="modal fade" id="modalEdit" tabindex="-1" aria-labelledby="modalEditLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="<?= base_url('hot_news2/edit'); ?>" method="post" enctype="multipart/form-data" >
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            type="text" id="gudang2" name="gudang2" placeholder="Masukkan gudang" value="" readonly />
            <div class="invalid-feedback">
...
$('.datepicker').datepicker();
  ...
  function getData(weekending) {
    $.ajax({
      url: "<?= base_url('hot_news2/getData/'); ?>" + weekending,
      success: function(result) {
        let results = JSON.parse(result);
        let data = "";

        if (!results[0]) {
          data += `<tr><td class="text-center" colspan="7">Tidak ada data ditampilkan. Silahkan pilih tanggal weekending untuk menampilkan data.</td></tr>`;
        } else {
          for (let i = 0; i < results.length; i++) {
            ...
            <a href="<?= base_url(); ?>hot_news2/hapus/${results[i].id}" class="btn btn-danger" onclick="return confirm('Yakin ingin dihapus?');"><i class="fa fa-trash"></i>Hapus</a>
            </td>
            </tr>
            `;
          }
  ...
  function getDataById(id) {
    ...
    $.ajax({
      url: "<?= base_url('hot_news2/getDataById/'); ?>" + id,
      success: function(result) {
        let results = JSON.parse(result);
