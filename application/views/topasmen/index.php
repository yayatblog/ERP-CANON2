...
<div class="modal fade" id="modalTambah" tabindex="-1" aria-labelledby="modalTambahLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="<?= base_url('top_asmen/tambah'); ?>" method="POST">
        <div class="modal-body">
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              <label for="jumlah_team">Jumlah Team</label>
...
<div class="modal fade" id="modalEdit" tabindex="-1" aria-labelledby="modalEditLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="<?= base_url('top_asmen/edit'); ?>" method="POST">
        <div class="modal-body">
          <div class="form-row">
            <div class="form-group col-md-6">
              <label for="Nama">Nama</label>
            ...
            <div class="form-group col-md-6">
              <label for="Gudang">Gudang</label>
              <input type="text" class="form-control" id="gudang2" name="gudang2" required>
            </div>
          </div>
          <div class="form-row">
            <div class="form-group col-md-6">
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="text" id="jumlah_team2" name="jumlah_team2" placeholder="Masukkan jumlah team" class="form-control">
...
<script>
  ...
  function getData(weekending) {
    ...
    $.ajax({
      url: "<?= base_url(); ?>top_asmen/getData/" + weekending,
      success: function(result) {
        let results = JSON.parse(result);
        let data = "";

        if (!results[0]) {
          data += `<tr><td colspan="14" class="text-center">Tidak ada data ditampilkan. Silahkan pilih tanggal weekending untuk menampilkan data.</td></tr>`;
        } else {
          for (let i = 0; i < results.length; i++) {
            ...
            <a href="<?= base_url(); ?>top_asmen/hapus/${results[i].id}" class="btn btn-danger mt-2" style="margin-left:35px" onclick="return confirm('Yakin ingin dihapus?');"><i class="fa fa-trash"></i>Hapus</a>
            </div>
            </div>
            </td>
            </tr>
  ...
  function getDataById(id) {
    $.ajax({
      url: "<?= base_url('top_asmen/getDataById/'); ?>" + id,
      success: function(result) {
        let results = JSON.parse(result);
