...
<form action="<?php echo base_url().'pengiriman/tambah_aksi'?>" method="post">
        ...
        <thead>
            ...
            <tr>
                ...
                <td style="text-align:center;">
                   <input type="text" class="form-control" id="kode" name="kode_id" data-toggle="modal" data-target="#myModal1" required>
                </td>
                <td>
                ...
                <td style="text-align:center;">
				 ...
				 <td style="text-align:center;">
                     <input type="text" class="form-control" id="qty" name="stok" required>
                </td>
