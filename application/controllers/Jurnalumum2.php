...
class Jurnalumum2 extends CI_Controller {
    ...
    public function index(){
        ...
        $this->load->view('jurnalumum2/index', $data);
    ...
    public function tambah(){
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('jurnalumum/tambah');
        }else {
    ...
    public function edit($id){
        ...
        $data['jurnalumum'] = $this->m_jurnalumum->getJurnalById($id);
        ...
        if ($this->form_validation->run() == FALSE) {
            $this->load->view('templates2/header',$topik);
            $this->load->view('jurnalumum/edit',$data);
        }else {
